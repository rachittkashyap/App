...
export default function TrainingDetail() {
  ...
  async function handleMarkComplete(taskId) {
    try {
      ...
      if (data.certificate) {
        toast('🎉 Congratulations! You completed this training and earned a certificate.', 'success');
      }
    } catch (err) {
  ...
  return (
    <div className="container section">
      ...
      {isAuthenticated && !enrollment && !training.isPaid && (
      ...
      {isAuthenticated && !enrollment && training.isPaid && (
        <BuyButton
          ...
          onSuccess={() => refreshStatus(training.id)}
        />
      )}
